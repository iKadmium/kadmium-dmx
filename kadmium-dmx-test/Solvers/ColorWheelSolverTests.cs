...
namespace kadmium_osc_dmx_dotnet_test.Solvers
{
    public class ColorWheelSolverTests
    {
        ...
        {
            ColorWheelEntry red = new ColorWheelEntry("Red", 0, 63, new kadmium_dmx_core.Color.RGB(255, 0, 0));
            ColorWheelEntry green = new ColorWheelEntry("Green", 64, 127, new kadmium_dmx_core.Color.RGB(0, 255, 0));
            ColorWheelEntry blue = new ColorWheelEntry("Blue", 128, 191, new kadmium_dmx_core.Color.RGB(0, 0, 255));
            ColorWheelEntry white = new ColorWheelEntry("White", 192, 255, new kadmium_dmx_core.Color.RGB(255, 255, 255));

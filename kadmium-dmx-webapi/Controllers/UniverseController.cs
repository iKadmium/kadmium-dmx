...
namespace kadmium_dmx_webapi.Controllers
{
    ...
    public class UniverseController : Controller
    {
        ...
        private static int GetDisplayMin(Fixture fixture, kadmium_dmx_core.Solvers.Attribute attribute)
        {
        ...
        private static int GetDisplayMax(Fixture fixture, kadmium_dmx_core.Solvers.Attribute attribute)
        {
            if (attribute is DMXChannel channel)
            {
                return channel.Max;

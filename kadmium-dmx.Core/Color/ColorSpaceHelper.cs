...
namespace kadmium_dmx_core.Color
{
    ...
    public sealed class ColorSpaceHelper
    {
        ...
        public static double GetColorDistance(Color.RGB c1, Color.RGB c2)
        {
		...
		/// </param>
		public static Color.RGB[] GetWheelColors(int alpha)
		{
            Color.RGB temp;
			int colorCount = 6*256;
            Color.RGB[] colors = new Color.RGB[colorCount];

			for(int i=0 ; i<colorCount; i++)
			{
				temp = HSBtoColor((int)((double)(i*255.0)/colorCount), 255, 255);
				colors[i] = new Color.RGB(alpha, temp.R, temp.G, temp.B);
			}
		...
		public static Color.RGB[] GetSpectrumColors(int alpha)
		{
            Color.RGB[] colors = new Color.RGB[256*6];
			//for(int i=127; i<256; i++) colors[i-127] = Color.FromArgb(alpha, i, 0, 0);
			for(int i=0; i<256; i++) colors[i] = new Color.RGB(alpha, 255, i, 0);
			for(int i=0; i<256; i++) colors[i + (256)] = new Color.RGB(alpha, 255- i, 255, 0);
			for(int i=0; i<256; i++) colors[i + (256*2)] = new Color.RGB(alpha, 0, 255, i);
			for(int i=0; i<256; i++) colors[i + (256*3)] = new Color.RGB(alpha, 0, 255- i, 255);
			for(int i=0; i<256; i++) colors[i + (256*4)] = new Color.RGB(alpha, i, 0, 255);
			for(int i=0; i<256; i++) colors[i + (256*5)] = new Color.RGB(alpha, 255, 0, 255- i);
		...
		/// Gets visible spectrum colors.
		/// </summary>
		public static Color.RGB[] GetSpectrumColors()
		{
		...
		*/
        ...
        public static RGB HexToColor(string hexColor)
        {
            string r, g, b;
        ...
        public static string RGBToHex(Color.RGB c)
        {
        ...
        public static RGB HSBtoColor(double h, double s, double b)
        {
        ...
        public static RGB HSBtoColor(int h, int s, int b)
        {
        ...
        /// </summary>
        /// <param name="hsl">The HSL structure to convert.</param>
        public static RGB HSLtoColor(double h, double s, double l)
        {
        ...
        /// </summary>
        /// <param name="hsl">The HSL structure to convert.</param>
        public static RGB HSLtoColor(HSL hsl)
        {
        ...
        public static RGB CMYKtoColor(float c, float m, float y, float k)
        {
        ...
        /// <param name="y">Yellow value (must be between 0 and 1).</param>
        /// <param name="k">Black value (must be between 0 and 1).</param>
        public static RGB CMYKtoColor(double c, double m, double y, double k)
        {
        ...
        public static RGB CMYKtoColor(CMYK cmyk)
        {
        ...
        /// <param name="u">U must be in [-0.436, +0.436].</param>
        /// <param name="v">V must be in [-0.615, +0.615].</param>
        public static RGB YUVtoColor(double y, double u, double v)
        {
        ...
        /// Converts YUV to a .net Color.
        /// </summary>
        public static RGB YUVtoColor(YUV yuv)
        {
